    ...
    <div class="bg-tertiary-900">
        ...
        <div class="relative mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2 gap-x-16 lg:px-8 lg:pt-16">
            <section 
                ...
                class="bg-tertiary-800 py-12 md:px-10 lg:col-start-2 lg:row-start-1 lg:mx-auto lg: w-full lg:max-w-lg lg:bg-transparent lg:pb-24 lg:pt-0"
            >
                ...
                <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
                    ...
                    <dl class="space-y-6 border-t border-white border-opacity-10 pt-6 font-medium">
